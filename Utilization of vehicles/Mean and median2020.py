...
utilize = new_data.query("year == '2020'").groupby(["day_of_week"], as_index=False)["day_of_week"].value_counts()\
...
data = []
monday = np.random.uniform(0, 1, 27003)
for i in monday:
    data.append(i)
tuesday = np.random.uniform(1, 2, 25644)
for i in tuesday:
    data.append(i)
Wednesday = np.random.uniform(2, 3, 25418)
for i in Wednesday:
    data.append(i)
Thursday = np.random.uniform(3, 4, 23724)
for i in Thursday:
    data.append(i)
Friday = np.random.uniform(4, 5, 27484)
for i in Friday:
    data.append(i)
Saturday = np.random.uniform(5, 6, 46029)
for i in Saturday:
    data.append(i)
Sunday = np.random.uniform(6, 7, 51730)
for i in Sunday:
    data.append(i)
